...
import numpy as np
from deeppncc.io import write_json, output_sensitive_gene, output_gene_sensitivity
from deeppncc.utils import preprocess_graph
from deeppncc.metrics import linkpred_metrics
from deeppncc.plot import plot_histogram, plot_top10_gene_sensitivity
...
def get_weight(model_path):
    ...
    e_dense_1_weights = sess.run("DeepPNCC/Encoder/e_dense_1_vars/weights:0")
    e_dense_2_weights = sess.run("DeepPNCC/Encoder/e_dense_2_vars/weights:0")
    e_dense_3_weights = sess.run("DeepPNCC/Encoder/e_dense_3_vars/weights:0")
