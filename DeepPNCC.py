...
def parse_args():
    ...
    parser.add_argument('--log_add_number', '-add', type=float, default=0, help='Perform log10(x+log_add_number) transform')  #执行log10（x+log_add_number）转换'
    ...
    parser.add_argument('--encode_dim', '-edim', type=int, nargs=2, default=[256, 256], help='Encoder structure')     #编码器结构
    parser.add_argument('--regularization_dim', '-rdim', type=int, nargs=2, default=[276, 256], help='Adversarial regularization structure') #对抗性规则化结构  #TODO:[125, 125, ]
    ...
    parser.add_argument('--dropout', '-d', type=float, default=0.03, help='Dropout rate (1 - keep probability)')  #dropout率
